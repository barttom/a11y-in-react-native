...
export const getMealsByCategoryId = (categoryId: Category['id']): Array<Meal> =>
  MEALS.filter(({categoryIds}) => categoryIds.indexOf(categoryId) > -1);

export const getMealById = (mealId: Meal['id']): Meal | null => {
